                    ...
                    [#if fargument.genericType == "struct"]
                        [#if fargument.context??]
                            [#if fargument.context=="global"]
                                [#if configModel.ipName=="DMA" || configModel.ipName=="BDMA" || configModel.ipName=="BDMA1"]
...
[#assign index1 =index1 + 1]
            ...
            [/#if]
            [/#list]
[#if S_FATFS_SDIO?? && (inst=="SDIO" || inst?starts_with("SDMMC")) && !(method.name=="HAL_RCCEx_PeriphCLKConfig")] [#-- if HAL_SD_Init  and SDIO is used with FATFS--]
[#else]		    
